...
const en = {
    login: {
        ...
        'login_tip1': "Warning: You are connected to the Testnet, please login with your TMW address.",
    ...
    mining: {
        ...
        binding_account: {
            ...
            'sharder_pool_tip1': "The Sharder Pool is a PoC mining pool application developed by Sharder where mining rights are determined by the PoC consensus. Miners with a Sharder Hub can create pools and normal users can participate in mining by staking TMW into the pools.",
    ...
    notification: {
        ...
        'ss_not_enough':'Your MW amount not enough',
    },
    enter: {
