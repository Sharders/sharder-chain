...
const en = {
    ...
    hubsetting: {
        ...
        'confirm_restart':"Comfirm and Reboot",
    ...
    mining:{
        ...
        index:{
            ...
            'net_mining':"Mining: ",
            'net_mining_number':"Number",
            'net_mining_number2':"Blocks",
            'my_assets':"My Assets: ",
            'my_income':"My Earnings: ",
            'view_ranking':"View Ranking",
            'net_income':"Total Network Earnings",
            'mining_description':"Sharder Pool",
        ...
        invite_friends:{
            ...
            'subtitle1':" Diamond rewards can be obtained within the application for every referral that downloads CAMP Wallet. ",
            'subtitle2':" 200 diamonds (max. 8000) can be obtained for every referral that registers for an account. ",
