...
const en = {
    login: {
        ...
        'welcome_tip': "Welcome to Sharder Chain",
    ...
    transaction: {
        ...
        'transaction_type_information': "Info",
    ...
    mining: {
        ...
        index: {
            ...
            'mining_no_pit_moment': "There is no pool at the moment",
        },
        invite_friends: {
    ...
    sso: {
        ...
        'balance_is_leased_out': "Your Sharder rights is leased out for the next __blocks__ blocks (until block __end__) to account __account__",
        'balance_leased_out_help': "Remember: This lease will take effect after the current lease has ended.",
        'leased_soon': "Leased Soon",
        'balance_will_be_leased_out': "Your Sharder rights will be leased out in __blocks__ blocks (block range __start__ to __end__) to account __account__",
        'balance_leasing_help': "Remember: Once submitted the lease cannot be cancelled.",
        'x_lessor': "1 lessor",
        'x_lessor_lease': "1 lessor has leased their Sharder rights to your account.",
    ...
    dialog: {
        ...
        'account_transaction_transaction_serial_number': "Transaction Number",
