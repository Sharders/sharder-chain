...
const en = {
    login: {
        ...
        'login_tip1': "Warning: You are connected to the Testnet, please login with your TCDWH address.",
    ...
    hubsetting: {
        ...
        'token_address': "Linked CDWH Address",
        'serial_no': "Serial No",
    ...
    mining: {
        attribute: {
            ...
            'investing_diamonds': "Stake TCDWH",
        ...
        binding_account: {
            ...
            'subtitle1': "The consensus pool is a DAPP developed based on the Sharder Chain. It provides a TCDWH based PoC mining pool where users can gain TCDWH through the pool.",
            'subtitle2': "Users can create pools or stake TCDWH to a pool and receive TCDWH rewards.",

            'description': "CDWH Info:",
            'description_tip1': "You must first create a TCDWH address within the wallet before accessing the application.",
            'description_tip2': " If you are a hub user, please import your hub's TCDWH address into the wallet for managing your mining assets and earned TCDWH.",
            'description_tip3': " Normal users should first create a TCDWH address to obtain airdropped TCDWH.",
            'description_tip4': " TCDWH within the application can be exchanged for CDWH (ERC-20)",

            'sharder_pool': "Sharder Pool Info:",
            'sharder_pool_tip1': "The Sharder Pool is a PoC mining pool application developed by Sharder where mining rights are determined by the PoC consensus. Miners with a Sharder Hub can create pools and normal users can participate in mining by staking TCDWH into the pools.",
            'sharder_pool_tip2': "Pool creators can earn a maximum of 30% of the pool earnings. 20,000 TCDWH must be staked to create a pool and 10,000 TCDWH must be staked to join a pool.",

            'tss_description': "TCDWH Info:",
            'tss_description_tip': "In order to provide optimal testing conditions for the Sharder Network and to boost community activity as well as encourage the community to market the Sharder project,\n" +
                "TCDWH (Testnet CDWH). This wallet will support creating and managing TCDWH addresses. \n" +
                "TCDWH are not circulated, it's solely used for testing and CDWH exchange in the consensus mining pool.",
            'ss_tip1': "TCDWH is the native token of the Sharder Test Network,",
            'ss_tip2': "TCDWH that were airdropped cannot be exchanged for CDWH (ERC-20), TCDWH earned through mining can be exchanged for CDWH (ERC-20) at a 2:1 ratio.",

            'tss_acquisition': "Obtaining TCDWH",
            'tss_acquisition_tip1': "According to official information from Sharder, a 1:1 ratio of TCDWH will be distributed according to the amount of CDWH (ERC-20) locked up.",
            'tss_acquisition_tip2': "Users without CDWH (ERC-20) could earn TCDWH from official Sharder events.",
            'tss_acquisition_tip3': "TCDWH can be earned by joining a pool through the application.",
            ...
            'bind_address_tip': " Please confirm whether your wallet has a TCDWH address then select an address for linking ",
            'address': "Address:",
            'tss_volume': "TCDWH Amount: ",
        ...
        create_history: {
            ...
            'pool_diamond': "Mining Pool CDWH",
            'max': "(Maximum)",
            'close': "Close",
        },
        diamond_exchange: {
            'diamond_exchange_title': "CDWH Exchange",
            'diamond_exchange_subtitle': " TCDWH can be exchanged for a limited time. Quantities are limited, so first come first serve!",
            'remaining': "Remaining:",
        ...
        free_collar_drill: {
            'free_collar_title': "Free CDWH",
            'free_collar_subtitle': "Obtain CDWH for free and prosper!",
            'collar': "Get",
        ...
        index: {
            ...
            'free_collar': "Free CDWH",
            'ss_exchange': "CDWH Exchange",
            'net_mining': "Mining ",
            ...
            'welfare_title2': "and get free CDWH by accessing the Sharder Pool application.",
            'reward_title': "TCDWH is the crypto currency in the Testnet. CDWH exchange functionality will be opened to reward community users participating in the testing. Quantities are limited, first come first serve! ",
            'remaining': "Remaining:",
            ...
            'tss_address_tile': "TCDWH Address",
            'tss_address_subtitle1': " The TCDWH address is the account address within the Sharder testnet. The consensus mining pool is a DAPP developed based on Sharder Chain. This address will also be your account for applications within the consensus mining pool.",
            'tss_address_subtitle2': " TCDWH does not have any value, it's solely used for testing and for exchanging diamonds with a 1:1 exchange rate.",
            ...
            'invest_ss': "Staked CDWH:",
            'invest_tip': " Please enter the amount of CDWH to be staked to the pool, 20,000 CDWH minimum ",
            'invest_ss_tip': " The CDWH staked for pool creation will be used for mining and for reward distribution ",
            'income_distribution': "Distribution:",
        ...
        my_assets: {
            ...
            'ss_storage_rebate': "CDWH Storage Rebate",
        },
        my_mining: {
            'i_join': "Joined",
            'i_create': "Created",
        ...
        rule_description: {
            ...
            'sharder_pool_tip1': "\"Sharder Pool\" is a PoC mining application developed by SHARDER. It uses the PoC consensus to compete for mining rights.Sharder hub owners can create pools and normal users can stake TCDWH to participate in mining.",
            'sharder_pool_tip2': "The pool creator can received a maximum of 30% for pool rewards. They must stake a minimum of 20,000 TCDWH to create a pool. A pool will have a lifecycle of 15 days and users must stake a minimum of 10,000 TCDWH to join a pool.",
            'ss': "TCDWH",
            'ss_tip1': "\"TCDWH\" is the native token of the Sharder testnet, the current circulated CDWH (ERC20) has to be locked up for staking.",
            'ss_tip2': "TCDWH will be airdropped at an exchange ratio of 1:1. The airdropped TCDWH cannot be exchange to CDWH(ERC20), but the TCDWH mined can be exchange to CDWH (ERC20) in a 2:1 exchange ratio.",
            'poc': "PoC Consensus",
            ...
            'reward_distribution': "Reward Distribution",
            'reward_distribution_tip1': "After calculations, 11,700,000 CDWH (ERC-20) tokens from the 100,000,000 CDWH (ERC-20) systematic rewards will be locked up and used towards testnet rewards. ",
    ...
    sso: {
        ...
        'buy_order_description': "Buy __quantity__ __asset_name__ assets at __nxt__ CDWH each.",
        'buy_order_description_help': "For each whole asset bought, you will pay __nxt__ CDWH, making a total of __total_nxt__ CDWH once everything has been purchased.",
        'sell_order_description': "Sell __quantity__ __asset_name__ assets at __nxt__ CDWH each.",
        'sell_order_description_help': "For each whole asset sold, you will receive __nxt__ CDWH, making a total of __total_nxt__ CDWH once everything has been sold.",
        ...
        'success_send_money': "CDWH has been sent.",
        'success_set_alias': "",
        ...
        'amount': "Amount",
        'fee': "Fee",
        'error_max_amount_warning': "Your amount is higher than __nxt__ CDWH. Are you sure you want to continue? Click the submit button again to confirm.",
        'error_max_fee_warning': "Your fee is higher than __nxt__ CDWH. Are you sure you want to continue? Click the submit button again to confirm.",
        ...
        'public_key_actions': "(Set account info, send a message, buy an alias, send CDWH, ...)",
        ...
        'error_fee_exceeds_max_account_control_fee': "Maximum total fees limit of __maxFee__ CDWH exceeded",
        ...
        'info_referenced_transaction_hash': "Due to you using a referenced transaction hash, 100 CDWH is held in custody until the transaction is confirmed or expires.",
    ...
    notification: {
        ...
        'hubsetting_account_address_error_format': "CDWH address format error",
        ...
        'new_account_warning': "You have a new account, please deposit some CDWH",
        ...
        'ss_not_enough':'Your CDWH amount not enough',
    },
    enter: {
    ...
    reward: {
        ...
        "exchange_tip":"Only multiples of 1000 CDWH can be exchanged and a minimum of 1000 CDWH must be made for each exchange. You can only exchange once every 7 days, please consider carefully before exchanging..",
        "exchange_time_tip":'Can only be redeemed once in 7 days',
        "insufficient_redemption":"Insufficient Redemption!"
    },
    exchange_list:{
        "exchange_title":"Exchange CDWH list",
