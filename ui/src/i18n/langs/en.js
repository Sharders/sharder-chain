...
const en = {
    login: {
        ...
        'login_tip1': "Warning: You are connected to the Testnet, please login with your TMWFS address.",
    ...
    hubsetting: {
        ...
        'set_sharder_account_password': "Set MWFS Password",
        'confirm_sharder_account_password': "Confirm MWFS Password",
    ...
    register: {
        ...
        'register_tip1': "Please write down or memorize these 12 words. This mnemonic phrase is required to access your MWFS account.",
    ...
    header: {
        ...
        'forging_error_no_admin_password': "Unable to confirm mining status, please enter the admin password.",
    ...
    mining: {
        attribute: {
            ...
            'investing_diamonds': "Stake TMWFS",
        ...
        binding_account: {
            ...
            'subtitle1': "The consensus pool is a DAPP developed based on the MWFS Chain. It provides a TMWFS based PoC mining pool where users can gain TMWFS through the pool.",
            'subtitle2': "Users can create pools or stake TMWFS to a pool and receive TMWFS rewards.",

            'description': "MWFS Info:",
            'description_tip1': "You must first create a TMWFS address within the wallet before accessing the application.",
            'description_tip2': " If you are a hub user, please import your hub's TMWFS address into the wallet for managing your mining assets and earned TMWFS.",
            'description_tip3': " Normal users should first create a TMWFS address to obtain airdropped TMWFS.",
            'description_tip4': " TMWFS within the application can be exchanged for MWFS (ERC-20)",

            'sharder_pool': "MWFS Pool Info:",
            'sharder_pool_tip1': "The Sharder Pool is a PoC mining pool application developed by Sharder where mining rights are determined by the PoC consensus. Miners with a Sharder Hub can create pools and normal users can participate in mining by staking TMWFS into the pools.",
            'sharder_pool_tip2': "Pool creators can earn a maximum of 30% of the pool earnings. 20,000 TMWFS must be staked to create a pool and 10,000 TMWFS must be staked to join a pool.",

            'tss_description': "TMWFS Info:",
            'tss_description_tip': "In order to provide optimal testing conditions for the Sharder Network and to boost community activity as well as encourage the community to market the Sharder project,\n" +
                "TMWFS (Testnet MWFS). This wallet will support creating and managing TMWFS addresses. \n" +
                "TMWFS are not circulated, it's solely used for testing and MWFS exchange in the consensus mining pool.",
            'ss_tip1': "TMWFS is the native token of the MWFS Test Network,",
            'ss_tip2': "TMWFS that were airdropped cannot be exchanged for MWFS (ERC-20), TMWFS earned through mining can be exchanged for MWFS (ERC-20) at a 2:1 ratio.",

            'tss_acquisition': "Obtaining TMWFS",
            'tss_acquisition_tip1': "According to official information from MWFS, a 1:1 ratio of TMWFS will be distributed according to the amount of MWFS (ERC-20) locked up.",
            'tss_acquisition_tip2': "Users without MWFS (ERC-20) could earn TMWFS from official MWFS events.",
            'tss_acquisition_tip3': "TMWFS can be earned by joining a pool through the application.",

            'poc': "PoC Consensus",
            'poc_tip1': "Users can compete for mining rights by running a node through the MWFS Client and mining rights are determined by the PoC consensus. The PoC weighted table is a type of on-chain transaction and it can be adjusted according to votes by the Sharder Community.",
            ...
            'bind_btn': " Link MWFS account to access application",
            ...
            'bind_address_tip': " Please confirm whether your wallet has a TMWFS address then select an address for linking ",
            'address': "Address:",
            'tss_volume': "TMWFS Amount: ",
        ...
        create_history: {
            ...
            'pool_diamond': "Mining Pool MWFS",
            'max': "(Maximum)",
            'close': "Close",
        },
        diamond_exchange: {
            'diamond_exchange_title': "MWFS Exchange",
            'diamond_exchange_subtitle': " TMWFS can be exchanged for a limited time. Quantities are limited, so first come first serve!",
            'remaining': "Remaining:",
        ...
        free_collar_drill: {
            'free_collar_title': "Free MWFS",
            'free_collar_subtitle': "Obtain MWFS for free and prosper!",
            'collar': "Get",
        ...
        index: {
            ...
            'sharder_mining': "MWFS Pool",
            'free_collar': "Free MWFS",
            'ss_exchange': "MWFS Exchange",
            'net_mining': "Mining ",
            ...
            'mining_description': "MWFS Pool Rules",
            ...
            'welfare_title2': "and get free MWFS by accessing the MWFS Pool application.",
            'reward_title': "TMWFS is the crypto currency in the Testnet. MWFS exchange functionality will be opened to reward community users participating in the testing. Quantities are limited, first come first serve! ",
            'remaining': "Remaining:",
            ...
            'tss_address_tile': "TMWFS Address",
            'tss_address_subtitle1': " The TMWFS address is the account address within the Sharder testnet. The consensus mining pool is a DAPP developed based on Sharder Chain. This address will also be your account for applications within the consensus mining pool.",
            'tss_address_subtitle2': " TMWFS does not have any value, it's solely used for testing and for exchanging diamonds with a 1:1 exchange rate.",
            ...
            'invest_ss': "Staked MWFS:",
            'invest_tip': " Please enter the amount of MWFS to be staked to the pool, 20,000 MWFS minimum ",
            'invest_ss_tip': " The MWFS staked for pool creation will be used for mining and for reward distribution ",
            'income_distribution': "Distribution:",
        ...
        my_assets: {
            ...
            'ss_storage_rebate': "MWFS Storage Rebate",
        },
        my_mining: {
            'i_join': "Joined",
            'i_create': "Created",
        ...
        rule_description: {
            ...
            'rule_subtitle': "MWFS Pool rules",
            'sharder_pool': "MWFS Pool",
            'sharder_pool_tip1': "\"Sharder Pool\" is a PoC mining application developed by SHARDER. It uses the PoC consensus to compete for mining rights.Sharder hub owners can create pools and normal users can stake TMWFS to participate in mining.",
            'sharder_pool_tip2': "The pool creator can received a maximum of 30% for pool rewards. They must stake a minimum of 20,000 TMWFS to create a pool. A pool will have a lifecycle of 15 days and users must stake a minimum of 10,000 TMWFS to join a pool.",
            'ss': "TMWFS",
            'ss_tip1': "\"TMWFS\" is the native token of the Sharder testnet, the current circulated MWFS (ERC20) has to be locked up for staking.",
            'ss_tip2': "TMWFS will be airdropped at an exchange ratio of 1:1. The airdropped TMWFS cannot be exchange to MWFS(ERC20), but the TMWFS mined can be exchange to MWFS (ERC20) in a 2:1 exchange ratio.",
            'poc': "PoC Consensus",
            'poc_tip1': "Every node running the MWFS client can compete for mining rights according to the PoC Consensus, the PoC weight table is also a type of on-chain transaction.",
            ...
            'reward_distribution': "Reward Distribution",
            'reward_distribution_tip1': "After calculations, 11,700,000 MWFS (ERC-20) tokens from the 100,000,000 MWFS (ERC-20) systematic rewards will be locked up and used towards testnet rewards. ",
    ...
    sso: {
        ...
        'buy_order_description': "Buy __quantity__ __asset_name__ assets at __nxt__ MWFS each.",
        'buy_order_description_help': "For each whole asset bought, you will pay __nxt__ MWFS, making a total of __total_nxt__ MWFS once everything has been purchased.",
        'sell_order_description': "Sell __quantity__ __asset_name__ assets at __nxt__ MWFS each.",
        'sell_order_description_help': "For each whole asset sold, you will receive __nxt__ MWFS, making a total of __total_nxt__ MWFS once everything has been sold.",
        ...
        'success_send_money': "MWFS has been sent.",
        'success_set_alias': "",
        ...
        'amount': "Amount",
        'fee': "Fee",
        'error_max_amount_warning': "Your amount is higher than __nxt__ MWFS. Are you sure you want to continue? Click the submit button again to confirm.",
        'error_max_fee_warning': "Your fee is higher than __nxt__ MWFS. Are you sure you want to continue? Click the submit button again to confirm.",
        ...
        'public_key_actions': "(Set account info, send a message, buy an alias, send MWFS, ...)",
        ...
        'error_fee_exceeds_max_account_control_fee': "Maximum total fees limit of __maxFee__ MWFS exceeded",
        ...
        'info_referenced_transaction_hash': "Due to you using a referenced transaction hash, 100 MWFS is held in custody until the transaction is confirmed or expires.",
    ...
    password_modal: {
        ...
        'input_sharder_site_pwd':"Please enter the MWFS official website password",
    },
    dialog: {
    ...
    notification: {
        ...
        'hubsetting_account_address_error_format': "MWFS address format error",
        ...
        'new_account_warning': "You have a new account, please deposit some MWFS",
        ...
        'ss_not_enough':'Your MWFS amount not enough',
    },
    enter: {
    ...
    reward: {
        ...
        "exchange_tip":"Only multiples of 1000 MWFS can be exchanged and a minimum of 1000 MWFS must be made for each exchange. You can only exchange once every 7 days, please consider carefully before exchanging..",
        "exchange_time_tip":'Can only be redeemed once in 7 days',
        "insufficient_redemption":"Insufficient Redemption!"
    },
    exchange_list:{
        "exchange_title":"Exchange MWFS list",
