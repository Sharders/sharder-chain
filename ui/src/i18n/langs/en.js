...
const en = {
    login: {
        ...
        'login_tip1': "You are connected to the Testnet, please login with your SS address or mnemonic phrase.",
    ...
    hubsetting: {
        ...
        'set_sharder_account_password': "Set Site Account Password",
        'confirm_sharder_account_password': "Confirm Site Account Password",
        ...
        'sharder_account_password': "Site Account Password",
    ...
    acrossChains: {
        ...
        'Heco_rate': "heco rate",
        'hmw_exchange_title': "HSS Exchange",
        ...
        'no_HSSExchangeAddress': "The acceptance address is heco exchange address, please transfer through the Asset Exchange page",
        ...
        'OKEx_rate': "OKEx rate",
        'omw_exchange_title': "OSS Exchange",
        ...
        'no_OSSExchangeAddress': "The acceptance address is OKEx exchange address, please transfer through the Asset Exchange page",
        ...
        'ETH_rate': "ETH rate",
        'emw_exchange_title': "ESS Exchange",
        ...
        'no_ESSExchangeAddress': "The acceptance address is ETH exchange address, please transfer through the Asset Exchange page",
        ...
        'Tron_rate': "Tron rate",
        'tmw_exchange_title': "TSS Exchange",
        ...
        'no_TSSExchangeAddress': "The acceptance address is Tron exchange address, please transfer through the Asset Exchange page",
        ...
        'BSC_rate': "BSC rate",
        'bmw_exchange_title': "BSS Exchange",
        ...
        'no_BSSExchangeAddress': "The acceptance address is BSC exchange address, please transfer through the Asset Exchange page",
        ...
        'tip-2': "2. On the premise that the address of the target chain is correct, if it is necessary to transfer the assets across the chain from SS chain, please transfer the corresponding quantity to the exchange in address ( ",
        'tip-3': "); when transferring the assets from ",
        'tip-4': "chain to SS chain, please transfer the corresponding quantity to the exchange on the ",
    ...
    transaction: {
        ...
        'transaction_type_mw_to_hmw': "SS->HSS",
        'transaction_type_hmw_to_mw': "HSS->SS",
        'transaction_type_mw_to_omw': "SS->OSS",
        'transaction_type_omw_to_mw': "OSS->SS",
        'transaction_type_mw_to_emw': "SS->ESS",
        'transaction_type_emw_to_mw': "ESS->SS",
        'transaction_type_mw_to_tmw': "SS->TSS",
        'transaction_type_tmw_to_mw': "TSS->SS",
        'transaction_type_mw_to_bmw': "SS->BSS",
        'transaction_type_bmw_to_mw': "BSS->SS",
        'self': "You",
    ...
    joinNet: {
        ...
        'mortgage': 'Mortgage(calculate corresponding SS based on selected disk capacity)',
    ...
    account_info: {
        ...
        'account_name_not_set_explain': 'is the SS amount currently available for use and it will only include the SS earnings from confirmed blocks (after 1 block confirmations).',
    ...
    header: {
        ...
        'open_console': "Console running，api logs…",
        'console': "console",
        'refresh': "refresh",
    },
    network: {
    ...
    mining: {
        ...
        binding_account: {
            ...
            'subtitle1': "The consensus pool is a DAPP developed based on the SS Chain. It provides a TSS based PoC mining pool where users can gain TSS through the pool.",
            ...
            'sharder_pool': "SS Pool Info:",
            'sharder_pool_tip1': "The Sharder Pool is a PoC mining pool application developed by Sharder where mining rights are determined by the PoC consensus. Miners with a mining machine can create pools and normal users can participate in mining by staking TSS into the pools.",
            ...
            'ss_tip1': "TSS is the native token of the SS Test Network,",
            ...
            'tss_acquisition_tip1': "According to official information from SS, a 1:1 ratio of TSS will be distributed according to the amount of SS (ERC-20) locked up.",
            'tss_acquisition_tip2': "Users without SS (ERC-20) could earn TSS from official SS events.",
            'tss_acquisition_tip3': "TSS can be earned by joining a pool through the application.",

            'poc': "PoC Consensus",
            'poc_tip1': "Users can compete for mining rights by running a node through the SS Client and mining rights are determined by the PoC consensus. The PoC weighted table is a type of on-chain transaction and it can be adjusted according to votes by the Sharder Community.",
            ...
            'bind_btn': " Link SS account to access application",
        ...
        index: {
            ...
            'mining_description': "SS Pool Rules",
            ...
            'welfare_title2': "and get free SS by accessing the SS Pool application.",
        ...
        rule_description: {
            ...
            'rule_subtitle': "SS Pool rules",
            'sharder_pool': "SS Pool",
            ...
            'poc': "PoC Consensus",
            'poc_tip1': "Every node running the SS client can compete for mining rights according to the PoC Consensus, the PoC weight table is also a type of on-chain transaction.",
    ...
    password_modal: {
        ...
        'input_sharder_site_pwd': "Please enter the SS official website password",
    },
    dialog: {
    ...
    notification: {
        ...
        'ss_not_enough': 'Your SS amount not enough, cant start mining',
