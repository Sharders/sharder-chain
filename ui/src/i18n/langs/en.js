...
const en = {
    login: {
        ...
        'login_tip1': "You are connected to the Testnet, please login with your MW address or mnemonic phrase.",
    ...
    hubsetting: {
        ...
        'set_sharder_account_password': "Set MW Password",
        'confirm_sharder_account_password': "Confirm MW Password",
        ...
        'sharder_account_password': "MW Password",
        ...
        'cancel': "Cancel",
        'update_hub_setting_success': "Machine Settings Updated",
        ...
        'quick_auth': "Node Mining Authorization",
    ...
    register: {
        ...
        'register_tip1': "Please write down or remember the phrase or key used to access your MW account.",
    ...
    account: {
        ...
        'download_no_response': "Block sync...",
        ...
        'synchronization_block': "Synchronizing blocks, please try again later",
        ...
        'storage_file': 'Data',
        'assets_across_chains': 'AssetExchange',
    ...
    acrossChains: {
        ...
        'tipChian4': "Make sure the binding Tron address is:",
        ...
        'tipChian5': "Make sure the binding BSC address is:",
        ...
        'tip-2': "2. On the premise that the address of the target chain is correct, if it is necessary to transfer the assets across the chain from MW chain, please transfer the corresponding quantity to the exchange in address ( ",
        'tip-3': "); when transferring the assets from ",
        'tip-4': "chain to MW chain, please transfer the corresponding quantity to the exchange on the ",
        ...
        'tip-10': "5. Contract Address is",
        'sure': "sure",
        'cancel': "cancel",
        'sameAddress': "the sameAddress than old",
        'notRightAddress': "Address format error",
        'bindAddress_incomplete': "This account is bound by authorization",
        'use_secretPhrase_tip': "Please use the secretPhrase to login!",
        'error': "Unable to connect to gateway service!",
        'bindAddress_double': "Duplicate address binding information, please contact the community staff to modify!",
        'address_error': "The address parameter is wrong, please check the address format or the address has been bound!",
    ...
    transaction: {
        ...
        'transaction_type_mw_to_hmw': "MWToHMW",
        'transaction_type_hmw_to_mw': "HMWToMW",
        'transaction_type_mw_to_omw': "MWToOMW",
        'transaction_type_omw_to_mw': "OMWToMW",
        'transaction_type_mw_to_emw': "MWToEMW",
        'transaction_type_emw_to_mw': "EMWToMW",
        'transaction_type_mw_to_tmw': "MWToTMW",
        'transaction_type_tmw_to_mw': "TMWToMW",
        'transaction_type_mw_to_bmw': "MWToBMW",
        'transaction_type_bmw_to_mw': "BMWToMW",
        'self': "You",
    ...
    network: {
        ...
        'block_avg_transaction_volume': "24H Total Txn Volume",
        ...
        'block_has_distribution_reward': "Crowd Miner Reward",
        'crowd_miner_reward_success': "Provide",
        'crowd_miner_reward_fail': "Not Provide",
    ...
    mining: {
        ...
        binding_account: {
            ...
            'subtitle1': "The consensus pool is a DAPP developed based on the MW Chain. It provides a TMW based PoC mining pool where users can gain TMW through the pool.",
            'subtitle2': "Users can create pools or stake TMW to a pool and receive TMW rewards.",

            'description': "MW Info:",
            'description_tip1': "You must first create a TMW address within the wallet before accessing the application.",
            'description_tip2': " If you are a hub user, please import your hub's TMW address into the wallet for managing your mining assets and earned TMW.",
            'description_tip3': " Normal users should first create a TMW address to obtain airdropped TMW.",
            'description_tip4': " TMW within the application can be exchanged for MW (ERC-20)",

            'sharder_pool': "MW Pool Info:",
            'sharder_pool_tip1': "The Sharder Pool is a PoC mining pool application developed by Sharder where mining rights are determined by the PoC consensus. Miners with a mining machine can create pools and normal users can participate in mining by staking TMW into the pools.",
            'sharder_pool_tip2': "Pool creators can earn a maximum of 30% of the pool earnings. 20,000 TMW must be staked to create a pool and 10,000 TMW must be staked to join a pool.",

            'tss_description': "TMW Info:",
            'tss_description_tip': "In order to provide optimal testing conditions for the Sharder Network and to boost community activity as well as encourage the community to market the Sharder project,\n" +
                "TMW (Testnet MW). This wallet will support creating and managing TMW addresses. \n" +
                "TMW are not circulated, it's solely used for testing and MW exchange in the consensus mining pool.",
            'ss_tip1': "TMW is the native token of the MW Test Network,",
            'ss_tip2': "TMW that were airdropped cannot be exchanged for MW (ERC-20), TMW earned through mining can be exchanged for MW (ERC-20) at a 2:1 ratio.",

            'tss_acquisition': "Obtaining TMW",
            'tss_acquisition_tip1': "According to official information from MW, a 1:1 ratio of TMW will be distributed according to the amount of MW (ERC-20) locked up.",
            'tss_acquisition_tip2': "Users without MW (ERC-20) could earn TMW from official MW events.",
            'tss_acquisition_tip3': "TMW can be earned by joining a pool through the application.",

            'poc': "PoC Consensus",
            'poc_tip1': "Users can compete for mining rights by running a node through the MW Client and mining rights are determined by the PoC consensus. The PoC weighted table is a type of on-chain transaction and it can be adjusted according to votes by the Sharder Community.",
        ...
        create_history: {
            ...
            'pool_diamond': "Mining Pool MW",
            'max': "(Maximum)",
            'close': "Close",
        },
        diamond_exchange: {
            'diamond_exchange_title': "MW Exchange",
            'diamond_exchange_subtitle': " TMW can be exchanged for a limited time. Quantities are limited, so first come first serve!",
            'remaining': "Remaining:",
        ...
        free_collar_drill: {
            'free_collar_title': "Free MW",
            'free_collar_subtitle': "Obtain MW for free and prosper!",
            'collar': "Get",
        ...
        index: {
            ...
            'sharder_mining': "MW Pool",
            'free_collar': "Free MW",
            'ss_exchange': "MW Exchange",
            'net_mining': "Mining ",
            ...
            'mining_description': "MW Pool Rules",
            ...
            'welfare_title2': "and get free MW by accessing the MW Pool application.",
            'reward_title': "TMW is the crypto currency in the Testnet. MW exchange functionality will be opened to reward community users participating in the testing. Quantities are limited, first come first serve! ",
            'remaining': "Remaining:",
            ...
            'tss_address_tile': "TMW Address",
            'tss_address_subtitle1': " The TMW address is the account address within the Sharder testnet. The consensus mining pool is a DAPP developed based on Sharder Chain. This address will also be your account for applications within the consensus mining pool.",
            'tss_address_subtitle2': " TMW does not have any value, it's solely used for testing and for exchanging diamonds with a 1:1 exchange rate.",
            ...
            'invest_ss': "Staked MW:",
            'invest_tip': " Please enter the amount of MW to be staked to the pool, 20,000 MW minimum ",
            'invest_ss_tip': " The MW staked for pool creation will be used for mining and for reward distribution ",
            'income_distribution': "Distribution:",
        ...
        my_assets: {
            ...
            'ss_storage_rebate': "MW Storage Rebate",
        },
        my_mining: {
            'i_join': "Joined",
            'i_create': "Created",
        ...
        rule_description: {
            ...
            'rule_subtitle': "MW Pool rules",
            'sharder_pool': "MW Pool",
            'sharder_pool_tip1': "\"Sharder Pool\" is a PoC mining application developed by SHARDER. It uses the PoC consensus to compete for mining rights.Sharder hub owners can create pools and normal users can stake TMW to participate in mining.",
            'sharder_pool_tip2': "The pool creator can received a maximum of 30% for pool rewards. They must stake a minimum of 20,000 TMW to create a pool. A pool will have a lifecycle of 15 days and users must stake a minimum of 10,000 TMW to join a pool.",
            'ss': "TMW",
            'ss_tip1': "\"TMW\" is the native token of the Sharder testnet, the current circulated MW (ERC20) has to be locked up for staking.",
            'ss_tip2': "TMW will be airdropped at an exchange ratio of 1:1. The airdropped TMW cannot be exchange to MW(ERC20), but the TMW mined can be exchange to MW (ERC20) in a 2:1 exchange ratio.",
            'poc': "PoC Consensus",
            'poc_tip1': "Every node running the MW client can compete for mining rights according to the PoC Consensus, the PoC weight table is also a type of on-chain transaction.",
            ...
            'reward_distribution': "Reward Distribution",
            'reward_distribution_tip1': "After calculations, 11,700,000 MW (ERC-20) tokens from the 100,000,000 MW (ERC-20) systematic rewards will be locked up and used towards testnet rewards. ",
    ...
    sso: {
        ...
        'buy_order_description': "Buy __quantity__ __asset_name__ assets at __nxt__ MW each.",
        'buy_order_description_help': "For each whole asset bought, you will pay __nxt__ MW, making a total of __total_nxt__ MW once everything has been purchased.",
        'sell_order_description': "Sell __quantity__ __asset_name__ assets at __nxt__ MW each.",
        'sell_order_description_help': "For each whole asset sold, you will receive __nxt__ MW, making a total of __total_nxt__ MW once everything has been sold.",
        ...
        'success_send_money': "MW has been sent.",
        'success_set_alias': "",
        ...
        'amount': "Amount",
        'fee': "Fee",
        'error_max_amount_warning': "Your amount is higher than __nxt__ MW. Are you sure you want to continue? Click the submit button again to confirm.",
        'error_max_fee_warning': "Your fee is higher than __nxt__ MW. Are you sure you want to continue? Click the submit button again to confirm.",
        ...
        'public_key_actions': "(Set account info, send a message, buy an alias, send MW, ...)",
        ...
        'error_fee_exceeds_max_account_control_fee': "Maximum total fees limit of __maxFee__ MW exceeded",
        ...
        'info_referenced_transaction_hash': "Due to you using a referenced transaction hash, 100 MW is held in custody until the transaction is confirmed or expires.",
    ...
    password_modal: {
        ...
        'input_sharder_site_pwd': "Please enter the MW official website password",
    },
    dialog: {
    ...
    notification: {
        ...
        'hubsetting_account_address_error_format': "MW address format error",
        ...
        'new_account_warning': "You have a new account, please deposit some MW",
    ...
    reward: {
        ...
        "exchange_tip": "Only multiples of 1000 MW can be exchanged and a minimum of 1000 MW must be made for each exchange. You can only exchange once every 7 days, please consider carefully before exchanging..",
        "exchange_time_tip": 'Can only be redeemed once in 7 days',
        "insufficient_redemption": "Insufficient Redemption!"
    },
    exchange_list: {
        "exchange_title": "Exchange MW list",
    ...
    poc: {
        'block_reward_tips_phase1': "NOTE: In network stable phase(Miner joining phase)，block reward is 0",
        'creator': "Creator",
        'type': "Type",
        'nodeType': "Node Type",
        ...
        'box_node': "Center Node",
        'hub_node': "Soul Node",
        'community_node': "Community Node",
        'sharder_node': "Community Node",
