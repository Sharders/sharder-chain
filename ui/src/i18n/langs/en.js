...
const en = {
    ...
    mining: {
        ...
        rule_description: {
            ...
            'sharder_pool_tip1': "\"Sharder Pool\" is a PoC mining Dapp developed by the SHARDER. Uses the PoC consensus to compete for mining rights. Sharder hub owners can create pools and users can stake TSS to participate in mining.",
            'sharder_pool_tip2': "The pool creator can received maximum 30% pool rewards and they must stake limit 20,000 TSS to create pool, a pool will have a lifecycle of 15 days, users can stake limit 10,000 TSS to join the pool.",
            'ss': "TSS",
            'ss_tip1': "\"TSS\"is the crypto currency of Testnet, miners need lock the current circulated SS(ERC20) to get the airdropped TSS, the exchange rate is 1:1.",
            'ss_tip2': "The airdropped TSS can't be exchange to SS(ERC20), but the mining reward TSS can be exchange to SS(ERC20) in 1:1 ratio.",
            'poc': "PoC Consensus",
            'poc_tip1': "Every SHARDER client runner can compete for mining rights according to PoC Consensus, PoC weight table can be adjusted by poll of all SHARDER community.",
            'poc_tip2': "You can found the detail of PoC weight table in the genesis block of Testnet，the every miner's PoC score be calculated by PoC weight table.",
            'reward_distribution': "Reward Distribution",
            'reward_distribution_tip1': "After measure, unlock 11,700,000 SS(ERC20) from 1 billion SS to reward in Testnet phase.",
            'reward_distribution_tip2': "Before the end of 2019.Q2., Sharder hub owners can received 90% mining rewards, other miners can received 10% mining rewards.",
        }
    },
    sso: {
