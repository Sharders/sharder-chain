...
const cn = {
    ...
    mining: {
        ...
        binding_account: {
            'title': "共识矿场说明",
            'subtitle1': "共识矿场是基于SHARDER开发的DAPP。提供基于TMWFS的PoC矿池，可以通过\"矿池\"获得\"TMWFS\"。",
            ...
            'sharder_pool': "豆匣矿池说明：",
            'sharder_pool_tip1': "\"豆匣矿池\"是SHARDER研发的PoC矿池应用，采用PoC共识争夺出块权。拥有豆匣矿机的矿工可以创建矿池，普通用户可以投入TMWFS参与其中。",
            ...
            'ss_tip1': "\"TMWFS\"为SHARDER测试网络的原生数币，",
            'ss_tip2': "空投的TMWFS无法再兑换为MWFS(ERC20)，挖矿获得的TMWFS则可以按照2:1的方式兑换为MWFS(ERC20)。",

            'tss_acquisition': "TMWFS获取",
            'tss_acquisition_tip1': "请根据SHARDER官网说明完成MWFS(ERC-20)的锁仓，以便按照1:1的比例获取TMWFS。",
            'tss_acquisition_tip2': "未持有MWFS(ERC-20)的用户也可能会收到TMWFS，以SHARDER官网的活动为准。",
        ...
        index: {
            ...
            'reward_title': "TMWFS为SHARDER测试网络中的原生加密数字货币，为了回馈参与测试网络的社区成员开放MWFS兑换功能，数量有限先到先得。",
            'remaining': "剩余:",
            ...
            'tss_address_subtitle1': "TMWFS地址为豆匣测试网络的账户地址,共识矿场是基于SHARDER开发的DAPP,此地址同时也是你共识矿场应用内的账户.",
        ...
        rule_description: {
            ...
            'sharder_pool_tip2': "矿池创建者最高可以获得30%的矿池收益，创建矿池至少需要抵押2万TMWFS，加入矿池至少需要投入1万TMWFS。",
            'ss': "TMWFS",
            'ss_tip1': "\"TMWFS\"为SHARDER测试网络的原生数币，需要对当前流通的MWFS(ERC20)完成锁仓，按照1:1空投TMWFS。",
            'ss_tip2': "空投的TMWFS无法再兑换为MWFS(ERC20)，挖矿获得的TMWFS则可以按照2:1的方式兑换为MWFS(ERC20)。",
            'poc': "PoC共识",
            'poc_tip1': "运行了SHARDER客户端的节点都可以参与挖矿权的争夺，挖矿权由PoC共识决定，PoC权重表也是一种上链交易。PoC权重表可由所有SHARDER社区的节点投票调整。",
            'poc_tip2': "测试网络运行PoC权重表可以在创世区块中查看，每个矿工都根据权重表计算其PoC算力。",
