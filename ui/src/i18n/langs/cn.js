...
const cn = {
    ...
    network: {
        ...
        'poc_score_network': '网络',
        'poc_score_performance': '交易性能',
        'poc_score_online_rate': '在线率',
        'poc_score_block_missing': '出块错过',
        'poc_score_bc': '分叉收敛',
        'miners_roll': "矿工名单",
        'miners_list': "矿工列表",
        'no_connection': "无连接",
    ...
    mining: {
        ...
        rule_description: {
            ...
            'sharder_mine': "豆匣矿场",
            'sharder_mine_tip1': "\"豆匣矿场\"是SHARDER官方提供的PoC矿池应用.",
            'sharder_mine_tip2': "以区块链技术为核心吗，挖矿为玩法。所有数据同步区块链网络,保证数据可靠及准确性.",
            'mining': "挖矿",
            'mining_tip1': "\"豆匣矿场\"的核心玩法是参与矿池，享受挖矿分红。",
            'mining_tip2': "挖矿成功获得TSS奖励,未成功挖矿将在下一个矿产继续争夺挖矿权。根据PoC分数决定挖矿的成功几率。",
            'pool': "矿池",
            'pool_tip1': "拥有豆匣矿机的用户可以创建矿池，用户可投入钻石参与矿池挖矿。目前全网矿池数量固定为300个。",
            'pool_tip2': "矿池的生命周期为48小时，生命周期结束后矿池将自动销毁。",
            'income_distribution': "收益分配",
            'income_distribution_tip1': "创建矿池时可以自定义收益分配比例，出块后将根据预设的比例进行奖励分配，投入矿池的TSS越多获得的奖励比例越高。",
        }
    },
    sso: {
