...
const cn = {
    ...
    hubsetting: {
        ...
        'sharder_account_password': "SS账户密码",
    ...
    transaction: {
        ...
        'transaction_type_mw_to_hmw': "SS兑换HSS",
        'transaction_type_hmw_to_mw': "HSS兑换SS",
        'transaction_type_mw_to_omw': "SS兑换OSS",
        'transaction_type_omw_to_mw': "OSS兑换SS",
        'transaction_type_mw_to_emw': "SS兑换ESS",
        'transaction_type_emw_to_mw': "ESS兑换SS",
        'transaction_type_mw_to_tmw': "SS兑换TSS",
        'transaction_type_tmw_to_mw': "TSS兑换SS",
        'transaction_type_mw_to_bmw': "SS兑换BSS",
        'transaction_type_bmw_to_mw': "BSS兑换SS",
    ...
    mining: {
        ...
        binding_account: {
            'title': "共识矿场说明",
            'subtitle1': "共识矿场是基于SS开发的DAPP。提供基于TSS的PoC矿池，可以通过\"矿池\"获得\"TSS\"。",
            ...
            'sharder_pool': "SS矿池说明：",
            'sharder_pool_tip1': "\"SS矿池\"是SS研发的PoC矿池应用，采用PoC共识争夺出块权。拥有SS矿机的矿工可以创建矿池，普通用户可以投入TSS参与其中。",
            'sharder_pool_tip2': "矿池创建者最高可以获得30%的矿池收益，创建矿池至少需要抵押2万TSS，加入矿池至少需要投入1万TSS。",

            'tss_description': "TSS说明:",
            'tss_description_tip': "为了更好的测试SS网络的运行情况,提高社区用户的活跃度同时推广SS,\n" +
                "TSS(Testnet SS)。本钱包将支持创建和管理TSS地址。\n" +
                "TSS不具备流通性,目的只做为测试及与共识矿场钻石产生兑换关系所用.",
            'ss_tip1': "\"TSS\"为SS测试网络的原生数币，",
            'ss_tip2': "空投的TSS无法再兑换为SS(ERC20)，挖矿获得的TSS则可以按照2:1的方式兑换为SS(ERC20)。",

            'tss_acquisition': "TSS获取",
            'tss_acquisition_tip1': "请根据SS官网说明完成SS(ERC-20)的锁仓，以便按照1:1的比例获取TSS。",
            'tss_acquisition_tip2': "未持有SS(ERC-20)的用户也可能会收到TSS，以SS官网的活动为准。",
            'tss_acquisition_tip3': "进入应用参与矿池挖矿可获得TSS.",

            'poc': "PoC共识",
            'poc_tip1': "运行了SS客户端的节点都可以参与挖矿权的争夺，挖矿权由PoC共识决定，PoC权重表也是一种上链交易。PoC权重表可由所有SS社区的节点投票调整。",
            'poc_tip2': "测试网络运行PoC权重表可以在创世区块中查看，每个矿工都根据权重表计算其PoC算力。",

            'bind_btn': "绑定SS账户进入应用",
            'bind_btn_tip1': "创建矿池权限也可以通过活动获得,请留意SS官网信息!",
        ...
        index: {
            ...
            'welfare_title2': "进入\"SS矿场\"应用免费领取",
            'reward_title': "TSS为SS测试网络中的原生加密数字货币，为了回馈参与测试网络的社区成员开放SS兑换功能，数量有限先到先得。",
            'remaining': "剩余:",
            ...
            'tss_address_subtitle1': "TSS地址为SS测试网络的账户地址,共识矿场是基于SS开发的DAPP,此地址同时也是你共识矿场应用内的账户.",
        ...
        rule_description: {
            'rule_title': "矿池规则",
            'rule_subtitle': "SS矿池规则说明",
            'sharder_pool': "SS矿池",
            'sharder_pool_tip1': "\"SS矿池\"是SS研发的PoC矿池应用，采用PoC共识争夺出块权。拥有SS矿机的矿工可以创建矿池，普通用户可以投入TSS参与其中。",
            'sharder_pool_tip2': "矿池创建者最高可以获得30%的矿池收益，创建矿池至少需要抵押2万TSS，加入矿池至少需要投入1万TSS。",
            'ss': "TSS",
            'ss_tip1': "\"TSS\"为SS测试网络的原生数币，需要对当前流通的SS(ERC20)完成锁仓，按照1:1空投TSS。",
            'ss_tip2': "空投的TSS无法再兑换为SS(ERC20)，挖矿获得的TSS则可以按照2:1的方式兑换为SS(ERC20)。",
            'poc': "PoC共识",
            'poc_tip1': "运行了SS客户端的节点都可以参与挖矿权的争夺，挖矿权由PoC共识决定，PoC权重表也是一种上链交易。PoC权重表可由所有SS社区的节点投票调整。",
            'poc_tip2': "测试网络运行PoC权重表可以在创世区块中查看，每个矿工都根据权重表计算其PoC算力。",
    ...
    sso: {
        ...
        'error_dgs_delivery_deadline_expired': "SS权力授权无效： 未找到接收者账户或未公布公钥。",
        'error_invalid_balance_leasing_no_public_key': "",
        'error_invalid_balance_leasing': "SS权力授权无效。",
    ...
    password_modal: {
        ...
        'input_sharder_site_pwd': "请输入SS官网密码",
    },
    dialog: {
    ...
    notification: {
        ...
        'ss_not_enough': '您的SS持有量不满足最低要求,不能开始挖矿',
    ...
    rules: {
        ...
        'plz_input_sharder_pwd': '请输入SS官网登录密码',
        'plz_input_sharder_pwd_again': '请再次输入SS官网登录密码',
        inconsistent_admin_password: "两次输入的节点管理密码不一致！",
        'inconsistent_sharder_password': "两次输入的SS官网注册密码不一致！",
    ...
    reward: {
        ...
        "exchange": "兑换",
        "exchange_sharder_account": "兑换到SS账户:  {account}",
        "redeemed": "已兑换",
        "convertible": "可兑换",
