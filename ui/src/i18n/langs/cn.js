...
const cn = {
    login: {
        ...
        'login_binding_hub_account_tip':"此Hub已绑定TCDWH地址 ",
    },
    hubsetting: {
    ...
    mining: {
        ...
        binding_account: {
            'title': "共识矿场说明",
            'subtitle1': "共识矿场是基于SHARDER开发的DAPP。提供基于TCDWH的PoC矿池，可以通过\"矿池\"获得\"TCDWH\"。",
            'subtitle2': "用户可创建\"矿池\"或则将TCDWH投入矿池挖矿，享受TCDWH分红。",

            'description': "CDWH说明:",
            'description_tip1': "在进入应用前需要你在当前钱包创建TCDWH地址.",
            'description_tip2': "如果你是矿机用户，请在钱包导入你的矿机挖矿的TCDWH地址，用于管理挖矿资产及获得对应TCDWH。",
            'description_tip3': "普通用户请先创建TCDWH地址,以便获得空投TCDWH",
            'description_tip4': "应用内的TCDWH可兑换为可流通的CDWH(ERC-20)",

            'sharder_pool': "豆匣矿池说明：",
            'sharder_pool_tip1': "\"豆匣矿池\"是SHARDER研发的PoC矿池应用，采用PoC共识争夺出块权。拥有豆匣矿机的矿工可以创建矿池，普通用户可以投入TCDWH参与其中。",
            'sharder_pool_tip2': "矿池创建者最高可以获得30%的矿池收益，创建矿池至少需要抵押2万TCDWH，加入矿池至少需要投入1万TCDWH。",

            'tss_description': "TCDWH说明:",
            'tss_description_tip': "为了更好的测试SHARDER网络的运行情况,提高社区用户的活跃度同时推广SHARDER,\n" +
                "TCDWH(Testnet CDWH)。本钱包将支持创建和管理TCDWH地址。\n" +
                "TCDWH不具备流通性,目的只做为测试及与共识矿场钻石产生兑换关系所用.",
            'ss_tip1': "\"TCDWH\"为SHARDER测试网络的原生数币，",
            'ss_tip2': "空投的TCDWH无法再兑换为CDWH(ERC20)，挖矿获得的TCDWH则可以按照2:1的方式兑换为CDWH(ERC20)。",

            'tss_acquisition': "TCDWH获取",
            'tss_acquisition_tip1': "请根据SHARDER官网说明完成CDWH(ERC-20)的锁仓，以便按照1:1的比例获取TCDWH。",
            'tss_acquisition_tip2': "未持有CDWH(ERC-20)的用户也可能会收到TCDWH，以SHARDER官网的活动为准。",
            'tss_acquisition_tip3': "进入应用参与矿池挖矿可获得TCDWH.",
            ...
            'bind_address': "绑定地址",
            'bind_address_tip': "检查到你的钱包持有TCDWH地址如下,请选择挖矿地址",
            'address': "地址: ",
            'tss_volume': "TCDWH 数量: ",
        ...
        diamond_exchange: {
            'diamond_exchange_title': "CDWH兑换",
            'diamond_exchange_subtitle': "CDWH限时开发兑换中,数量有限先到先得",
            'remaining': "剩余:",
            'description': "说明:",
            'not_open': "即将开放...",
        ...
        free_collar_drill: {
            'free_collar_title': "免费领CDWH",
            'free_collar_subtitle': "免费领取TCDWH,走向致富之路",
            'collar': "立即领取",
            'daily_login': "每日登陆",
        ...
        index: {
            ...
            'reward_title': "TCDWH为SHARDER测试网络中的原生加密数字货币，为了回馈参与测试网络的社区成员开放CDWH兑换功能，数量有限先到先得。",
            'remaining': "剩余:",
            ...
            'join_friend': "邀请好友",
            'diamond_exchange': "CDWH兑换",
            'about_us': "关于我们",
            'follow_us': "关注我们",
            'webside': "www.0xdigit.com",
            'set_name': "名称设置",
            'set_name_tip': "请输入名称",
            'tss_address_tile': "TCDWH地址说明",
            'tss_address_subtitle1': "TCDWH地址为豆匣测试网络的账户地址,共识矿场是基于SHARDER开发的DAPP,此地址同时也是你共识矿场应用内的账户.",
            'tss_address_subtitle2': "TCDWH不具备价格流通.目前只能作为测试及与矿场砖石产生兑换关系所用,与钻石为一一对应关系。",
            'mining_ranking': "挖矿排行",
            'account': "账户",
            'ss_volume': "已挖矿数量",
            'unit_ming': "名",
            ...
            'mining_setting': "矿池设定",
            'invest_ss': "投入CDWH:",
            'invest_tip': "请输入投入矿池CDWH数量, 最低20000CDWH",
            'invest_ss_tip': "创建矿池时投入的CDWH也将参与挖矿并获得收益分配",
            'income_distribution': "收益分配:",
        ...
        my_assets: {
            'whether': "到底了...",
            'click_load': "点击加载",
            'total_asset': "总资产(TCDWH)",
            'available_asset': "可用资产",
            'frozen_assets': "冻结资产(挖矿中)",
            'asset_record': "资产记录",
            'mining_reward': "挖矿奖励",
            'ss_storage_rebate': "CDWH存储返利",
        },
        my_mining: {
            'i_join': "我加入的",
            'i_create': "我创建的",
        ...
        rule_description: {
            ...
            'sharder_pool_tip2': "矿池创建者最高可以获得30%的矿池收益，创建矿池至少需要抵押2万TCDWH，加入矿池至少需要投入1万TCDWH。",
            'ss': "TCDWH",
            'ss_tip1': "\"TCDWH\"为SHARDER测试网络的原生数币，需要对当前流通的CDWH(ERC20)完成锁仓，按照1:1空投TCDWH。",
            'ss_tip2': "空投的TCDWH无法再兑换为CDWH(ERC20)，挖矿获得的TCDWH则可以按照2:1的方式兑换为CDWH(ERC20)。",
            'poc': "PoC共识",
            'poc_tip1': "运行了SHARDER客户端的节点都可以参与挖矿权的争夺，挖矿权由PoC共识决定，PoC权重表也是一种上链交易。PoC权重表可由所有SHARDER社区的节点投票调整。",
            'poc_tip2': "测试网络运行PoC权重表可以在创世区块中查看，每个矿工都根据权重表计算其PoC算力。",
            'reward_distribution': "奖励分配",
            'reward_distribution_tip1': "经测算从1亿系统奖励中解锁 11,700,000 CDWH(ERC20)用于测试网的奖励。",
    ...
    sso: {
        ...
        'buy_order_description': "以每个资产 __nxt__ CDWH 购买 __quantity__ __asset_name__。",
        'buy_order_description_help': "每购买一个整体资产，您将要支付 __nxt__ CDWH，当购买所有时，总量为__total_nxt__ CDWH。",
        'sell_order_description': "以每个资产 __nxt__ CDWH 出售 __quantity__ __asset_name__。",
        'sell_order_description_help': "每出售一个整体资产，您将会收到 __nxt__ CDWH，当出售所有时，总量为__total_nxt__ CDWH。",
        ...
        'amount': "数额",
        'fee': "手续费",
        'error_max_amount_warning': "您的数量高于 __nxt__ CDWH。你确定要继续吗？请再次单击提交按钮以确认。",
        'error_max_fee_warning': "您的手续费高于 __nxt__ CDWH。您确定要继续吗？请再次单击提交按钮以确认。",
        ...
        'public_key_actions': "（设置帐户信息，发送一条信息，购买一个别名，发送 CDWH，...）",
        ...
        'error_fee_exceeds_max_account_control_fee': "已超过 __maxFee__ CDWH 的最大手续费限制",
        ...
        'info_referenced_transaction_hash': "由于您使用了一个参考交易哈希，将抵押100个 CDWH 直到交易确认或过期。",
    ...
    notification: {
        ...
        'hubsetting_account_address_error_format': "关联CDWH地址格式错误！",
        ...
        'ss_not_enough':'您的账户总资产不足20000CDWH,不能开始挖矿',
    },
    enter: {
    ...
    reward: {
        ...
        "redeemed":"已兑换",
        "convertible":"可兑换",
        "exchange_tip":"每次兑换不能低于1000CDWH，兑换数量只能是1000的倍数并且7天内只能兑换一次，请谨慎选择兑换数量。",
        "exchange_time_tip":'7天内只能兑换1次',
        "insufficient_redemption":"可兑换数量不足!",
    },
    exchange_list:{
        "exchange_title":"兑换CDWH列表",
