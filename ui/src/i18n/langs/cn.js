...
const cn = {
    ...
    mining: {
        ...
        binding_account: {
            ...
            'sharder_pool': "豆匣矿池说明：",
            'sharder_pool_tip1': "\"豆匣矿池\"是MW研发的PoC矿池应用，采用PoC共识争夺出块权。拥有豆匣矿机的矿工可以创建矿池，普通用户可以投入TMW参与其中。",
        ...
        index: {
            ...
            'tss_address_subtitle1': "TMW地址为豆匣测试网络的账户地址,共识矿场是基于MW开发的DAPP,此地址同时也是你共识矿场应用内的账户.",
    ...
    notification: {
        ...
        'ss_not_enough':'您的账户总资产不足20000MW,不能开始挖矿',
    },
    enter: {
