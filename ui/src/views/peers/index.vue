                        ...
                        <table class="table table-striped"  id="peers_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button class="list_button w40">连接</button>
                                        <button class="list_button w50">黑名单</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="image_text">
                                    ...
                                    <td>
                                        <button class="list_button w40">连接</button>
                                        <button class="list_button w50 csp">黑名单</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="image_text">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" data-i18n="blacklist_peer" style="text-align: center">加入黑名单</h4>
                    </div>
