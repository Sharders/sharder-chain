...
<!--            </el-row>-->
            <div class="block_account mb20">
                ...
                <div class="w pt60">
                    ...
                    <div class="account_tool">
                        ...
                        <button class="common_btn imgBtn writeBtn" v-if="whetherShowOnChainBtn()"
                        ...
                        <button class="common_btn imgBtn writeBtn" v-if="whetherShowJoinNetBtn()"
                    ...
                    <div class="list_content data_loading">
                        <table class="table table_striped" id="blocks_table">
                            ...
                            <tr v-for="(transaction,index) in accountTransactionList"
                                ...
                                <td class="pc-table">
                                    {{ $global.getTransactionAmountNQT(transaction, accountInfo.accountRS) }}
                                </td>
                                ...
                                <td class=" image_text w300 pc-table">
                                    ...
                                    <span class="linker" v-else-if="transaction.type === 12"
                                          @click="openBlockInfoDialog(transaction.height)">System</span>
                                    <span class="linker" @click="openAccountInfoDialog(transaction.senderRS)"
                                         ...
                                         <span class="linker" @click="openAccountInfoDialog(transaction.recipientRS)"
                                               v-if="transaction.type === 8 && transaction.subtype === 3 &&transaction.recipientRS !== accountInfo.accountRS">
                                ...
                                <td class="pc-table">
                                    {{ $global.returnObj(transaction.block, transaction.confirmations) }}
                                </td>
                    ...
                    <div class="modal-body modal-message">
                        <el-form>
                            <el-form-item :label="$t('sendMessage.file')">
                                ...
                                <input id="storageFile" ref="storageFile" type="file" @change="storageFileChange"
                    ...
                    <div class="modal-body modal-message">
                        <el-form>
                            <el-form-item :label="$t('sendMessage.file')">
                                ...
                                <input id="onChainFile" ref="onChainFile" type="file" @change="onChainFileChange"
                    ...
                    <div class="modal-body modal-message">
                        <el-form>
                            <el-form-item :label="$t('joinNet.disk_capacity')">
                                <el-slider v-model="capacity" :format-tooltip="formatInputDiskCapacity"
                                           :max="maxCapacity" @change="calculatePledge"></el-slider>
                            </el-form-item>
                    ...
                    <div class="modal-body modal-message">
                        <el-form>
                            <el-form-item :label="$t('sendMessage.json_file')">
                                ...
                                <input id="parseFile" ref="parseFile" type="file" accept="application/json"
                                       @change="parseFileChange" v-if="parsefile === null"/>
                            </el-form-item>
                            <el-form-item :label="$t('transfer.secret_key')" v-if="!secretPhrase">
        ...
        <div class="modal_hubSetting" id="hub_init_setting" v-show="hubInitDialog">
            ...
            <div class="modal-body">
                <el-form label-position="left" style=" max-height: 500px;overflow: auto;"
                         v-loading="hubsetting.loadingData" :model="hubsetting" status-icon :rules="formRules"
                    ...
                    <el-form-item :label="$t('hubsetting.serial_no')"
        ...
        <div class="modal_hubSetting" id="hub_setting" v-loading="hubsetting.loadingData" v-show="hubSettingDialog">
            <div class="modal-header" @click="displaySerialNo('setting')">
                <button class="common_btn long" @click="openAdminDialog('factoryReset')">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>
                            ...
                            <el-tooltip class="item" effect="dark" :content="$t('account_info.account_balance_explain')"
                                        placement="top-start">
...
export default {
    ...
    methods: {
        ...
        whetherShowHubSettingBtn() {
            ...
            3. NodeType is Hub;
            4. Hub bind address must equals to user account address;
