...
export default {
    ...
    displayName: "Sharder",
    displaySymbol: "SS",
    projectPrefixStr: "SSA",
    loginState: 'hub',
    foundationHost: 'sharder.org',
    foundationTestHost: 'sharder.org',
    unit: " SS",
    primaryColor: vars.primary_color,
    primaryColor_dd: vars.primary_color_dd,
    pattern: /SSA-([A-Z0-9]{4}-){3}[A-Z0-9]{5}/,
    receiverPrefixStr: "SSA-____-____-____-_____",
    ...
    $vue: {},
    placeholder: "--",
    acrossChainExchangeEnable: false,
    acrossUnit: {HECO: "HSS", OKEX: "OSS", ETH: "ESS", TRON: "TSS", BSC: "BSS"},
    acrossUnitVal: {HECO: 100000000, OKEX: 100000000, ETH: 100000000, TRON: 100000000, BSC: 100000000,},
    unitValue: 100000000,
