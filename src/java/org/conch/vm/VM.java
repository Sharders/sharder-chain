...
import org.conch.vm.program.Stack;
...
import static org.conch.vm.OpCode.*;
...
public class VM {
    ...
    public VM() {
        // TODO wj the value doesn't come from the config file
        vmTrace = false;
        dumpBlock = -1;
        ...
        try {
            ...
            switch (op) {
                ...
                case STATICCALL:
                    ...
                    DataWord maxAllowed = Utils.allButOne64th(callGasWord);
                    adjustedCallGas = callGasWord.compareTo(maxAllowed) > 0 ? maxAllowed : callGasWord;
    ...
    /**
     * @deprecated TODO: Remove after a few versions
