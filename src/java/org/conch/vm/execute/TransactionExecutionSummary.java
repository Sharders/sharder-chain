...
import org.conch.vm.LogInfo;
import org.conch.vm.program.InternalTransaction;
...
import static org.conch.vm.util.BIUtil.toBI;
...
public class TransactionExecutionSummary {
    ...
    public TransactionExecutionSummary(Transaction transaction) {
        ...
        this.gasLimit = toBI(contract.getGasLimit());
        this.gasPrice = toBI(contract.getGasPrice());
        this.value = toBI(transaction.getAmountNQT());
    }
    ...
    public byte[] getTransactionHash() {
        return getTransaction().getFullHash().getBytes();
    }
