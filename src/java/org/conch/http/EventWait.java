...
import org.conch.http.EventListener.PendingEvent;
 ...
 * sharder.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than sharder.apiEventTimeout.</li>
 * </ul>
 *
