...
public final class Currency {
    ...
    static void addCurrency(AccountLedger.LedgerEvent event, long eventId, Transaction transaction, Account senderAccount,
    ...
    static void increaseReserve(AccountLedger.LedgerEvent event, long eventId, Account account, long currencyId, long amountPerUnitNQT) {
    ...
    static void claimReserve(AccountLedger.LedgerEvent event, long eventId, Account account, long currencyId, long units) {
    ...
    static void transferCurrency(AccountLedger.LedgerEvent event, long eventId, Account senderAccount, Account recipientAccount,
    ...
    void delete(AccountLedger.LedgerEvent event, long eventId, Account senderAccount) {
