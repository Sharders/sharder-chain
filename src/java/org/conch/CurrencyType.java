...
public enum CurrencyType {
    ...
    static void validate(Currency currency, Transaction transaction) throws ConchException.ValidationException {
        if (currency == null) {
    ...
    static void validate(int type, Transaction transaction) throws ConchException.ValidationException {
    ...
    static void validateCurrencyNaming(long issuerAccountId, Attachment.MonetarySystemCurrencyIssuance attachment) throws ConchException.ValidationException {
