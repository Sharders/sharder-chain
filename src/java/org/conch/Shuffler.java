...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Conch.getIntProperty("sharder.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Conch.getBlockchain().getHeight() + 720;
    ...
    private volatile ConchException.NotCurrentlyValidException failureCause;
    ...
    public ConchException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            ...
            builder.timestamp(Conch.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new ConchException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends ConchException {
