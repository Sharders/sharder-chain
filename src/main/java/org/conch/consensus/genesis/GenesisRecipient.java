...
public class GenesisRecipient {
    ...
    //genesis recipients
    static private final List<GenesisRecipient> devnetRecipients = Lists.newArrayList(
    ...
    static private final List<GenesisRecipient> testnetRecipients = Lists.newArrayList(
            new GenesisRecipient(6219247923802955552L, 5000000000L,
                    new byte[]{-71, -79, -127, -96, -9, -33, -46, -124, 122, 42, -79, 20, -45, -4, 72, 83, -69, 78, 65, 64, 31, 71, 33, -22, -80, 68, -12, -10, -115, 22, -40, 118},
                    new byte[]{-28,-84,16,39,-23,-81,-10,-22,-18,-60,-10,11,123,119,-79,73,-120,-123,41,97,67,39,-69,31,36,125,26,-124,35,-10,27,0,-116,-89,-110,77,-79,97,-83,127,-17,
                            65,-40,72,-125,-7,55,32,-31,67,-120,23,-45,122,-52,15,27,-95,-105,-118,12,-75,-104,66}),
    ...
    static private final List<GenesisRecipient> recipients = Lists.newArrayList();
    
    private static List<GenesisRecipient> recipientList(){
        return Constants.isDevnet() ? devnetRecipients : (Constants.isTestnet() ? testnetRecipients : recipients);
    }
    
    public static GenesisRecipient getByAccountId(long accountId) {
        List<GenesisRecipient> searchList = recipientList();

        for(GenesisRecipient recipient : searchList){
