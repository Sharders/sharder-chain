...
public abstract class CurrencyExchangeOffer {
    ...
    public static void publishOffer(Transaction transaction, Attachment.MonetarySystemPublishExchangeOffer attachment) {
    ...
    public static void exchangeCurrencyForSS(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    public static void removeOffer(AccountLedger.LedgerEvent event, CurrencyBuyOffer buyOffer) {
