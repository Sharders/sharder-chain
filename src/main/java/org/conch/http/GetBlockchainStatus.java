...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("fullVersion", Conch.getFullVersion());
        response.put("cosLastUpgradeDate", Conch.getCosLastUpgradeDate());
        ...
        response.put("isTestnet", Constants.getNetwork().getName());
