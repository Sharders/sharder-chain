 ...
 * <p>
 * A funding monitor will transfer MWFS, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * MWFS amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws ConchException        Unable to process request
     */
    @Override
