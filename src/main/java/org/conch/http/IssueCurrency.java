 ...
 * <p>
 * A currency is the basic block of the Conch Monetary System it can be exchanged with CDWH, transferred between accounts,
 ...
 * <li>minReservePerUnitNQT - the minimum CDWH value per unit to allow the currency to become active
 * For {@link CurrencyType#RESERVABLE} currency
 ...
 * When a {@link CurrencyType#RESERVABLE} becomes active, in case it is {@link CurrencyType#CLAIMABLE} the CDWH used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link CurrencyType#RESERVABLE} becomes active, in case it is non {@link CurrencyType#CLAIMABLE} the CDWH used for
