 ...
 * account ledger tracks all account changes as determined by the sharder.ledgerAccounts,
 * sharder.ledgerLogUnconfirmed and sharder.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than sharder.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the sharder.maxAPIRecords property
 ...
 *     <tr>
 *       <td>CONCH_BALANCE</td>
 *       <td>Change in the MWFS balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *       <td>Change in the unconfirmed MWFS balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws ConchException        Invalid request
     */
    @Override
