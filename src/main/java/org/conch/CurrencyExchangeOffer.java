...
public abstract class CurrencyExchangeOffer {
    ...
    static void publishOffer(Transaction transaction, Attachment.MonetarySystemPublishExchangeOffer attachment) {
        ...
        if (previousOffer != null) {
            CurrencyExchangeOffer.removeOffer(AccountLedger.LedgerEvent.CURRENCY_OFFER_REPLACED, previousOffer);
        }
    ...
    static void exchangeCurrencyForSS(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangeSSForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void removeOffer(AccountLedger.LedgerEvent event, CurrencyBuyOffer buyOffer) {
