...
var NRS = (function(NRS, $) {
    ...
    NRS.initSettings = function() {
        ...
        $("#settings_form").submit(function(event) {ACCOUNT_FXT
	...
	NRS.setup.network = function() {
		...
		var options = {
			"id": sidebarId,
			//"titleHTML": '<i class="fa fa-sitemap"></i> <span data-i18n="cc_network">Dashboard</span>',
			"titleHTML": '<i class="fa fa-connectdevelop"></i> <span data-i18n="cc_network">Dashboard</span>',
			"page": 'blocks',
			"desiredPosition": 20
		};
		NRS.addTreeviewSidebarMenuItem(options);
		options = {
			"titleHTML": '<span data-i18n="blocks">Blocks</span>',
			"type": 'PAGE',
			"page": 'blocks'
		};
		NRS.appendMenuItemToTSMenuItem(sidebarId, options);
		options = {
			"titleHTML": '<span data-i18n="peers">Peers</span>',
			"type": 'PAGE',
			"page": 'peers'
			// "page":'peers'
		};
		NRS.appendMenuItemToTSMenuItem(sidebarId, options);
		options = {
			"titleHTML": '<span data-i18n="generators">Miner</span>',
			"type": 'PAGE',
			"page": 'generators'
		};
		NRS.appendMenuItemToTSMenuItem(sidebarId, options);
	...
	//NRS.showBarForIOS = function() {
	//	if (window["cordova"] && "iOS" == device.platform) {
	//		cordova.plugins.Keyboard.hideKeyboardAccessoryBar(false);
	//		console.log("show KeyboardAccessoryBar");
	//	}
	//};
    //
	//NRS.hideBarForIOS = function() {
	//	if (window["cordova"] && "iOS" == device.platform) {
	//		cordova.plugins.Keyboard.hideKeyboardAccessoryBar(true);
	//		console.log("hide KeyboardAccessoryBar");
	//	}
	//};
